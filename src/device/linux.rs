...
impl Into<evdev_rs::InputEvent> for event::KeyboardEvent {
    fn into(self) -> evdev_rs::InputEvent {
        InputEvent {
            time: TimeVal {
                tv_sec: self.time.timestamp(),
                tv_usec: self.time.timestamp_subsec_micros() as i64,
            },
            event_type: enums::EventType::EV_KEY,
            event_code: self.code.into(),
            value: self.state as i32,
        }
    }
}

impl Into<event::KeyboardEvent> for evdev_rs::InputEvent {
    fn into(self) -> event::KeyboardEvent {
        event::KeyboardEvent {
            time: Local.timestamp(self.time.tv_sec, self.time.tv_usec as u32),
            code: self.event_code.into(),
            state: self.value.into(),
        }
    }
}

impl Into<enums::EventCode> for event::KeyCode {
    fn into(self) -> enums::EventCode {
        enums::EventCode::EV_KEY(enums::int_to_ev_key(self as u32).unwrap())
    }
}

impl Into<event::KeyCode> for enums::EventCode {
    fn into(self) -> event::KeyCode {
        match self {
            ...
            enums::EventCode::EV_KEY(enums::EV_KEY::KEY_RIGHTBRACE) => {
                event::KeyCode::KC_RIGHTBRACE
            }
            ...
            enums::EventCode::EV_KEY(enums::EV_KEY::KEY_APOSTROPHE) => {
                event::KeyCode::KC_APOSTROPHE
            }
            ...
            enums::EventCode::EV_KEY(enums::EV_KEY::KEY_RIGHTSHIFT) => {
                event::KeyCode::KC_RIGHTSHIFT
            }
            enums::EventCode::EV_KEY(enums::EV_KEY::KEY_KPASTERISK) => {
                event::KeyCode::KC_KPASTERISK
            }
            ...
            enums::EventCode::EV_KEY(enums::EV_KEY::KEY_SCROLLLOCK) => {
                event::KeyCode::KC_SCROLLLOCK
            }
            ...
            enums::EventCode::EV_KEY(enums::EV_KEY::KEY_VOLUMEDOWN) => {
                event::KeyCode::KC_VOLUMEDOWN
            }
            ...
            enums::EventCode::EV_KEY(enums::EV_KEY::KEY_KPPLUSMINUS) => {
                event::KeyCode::KC_KPPLUSMINUS
            }
            ...
            enums::EventCode::EV_KEY(enums::EV_KEY::KEY_DELETEFILE) => {
                event::KeyCode::KC_DELETEFILE
            }
            ...
            enums::EventCode::EV_KEY(enums::EV_KEY::KEY_SCROLLDOWN) => {
                event::KeyCode::KC_SCROLLDOWN
            }
            enums::EventCode::EV_KEY(enums::EV_KEY::KEY_KPLEFTPAREN) => {
                event::KeyCode::KC_KPLEFTPAREN
            }
            ...
            enums::EventCode::EV_KEY(enums::EV_KEY::KEY_FASTFORWARD) => {
                event::KeyCode::KC_FASTFORWARD
            }
            ...
            enums::EventCode::EV_KEY(enums::EV_KEY::KEY_KBDILLUMUP) => {
                event::KeyCode::KC_KBDILLUMUP
            }
            ...
            enums::EventCode::EV_KEY(enums::EV_KEY::KEY_FORWARDMAIL) => {
                event::KeyCode::KC_FORWARDMAIL
            }
            ...
            enums::EventCode::EV_KEY(enums::EV_KEY::KEY_VIDEO_NEXT) => {
                event::KeyCode::KC_VIDEO_NEXT
            }
            enums::EventCode::EV_KEY(enums::EV_KEY::KEY_VIDEO_PREV) => {
                event::KeyCode::KC_VIDEO_PREV
            }
            ...
            enums::EventCode::EV_KEY(enums::EV_KEY::KEY_DISPLAY_OFF) => {
                event::KeyCode::KC_DISPLAY_OFF
            }
            ...
            enums::EventCode::EV_KEY(enums::EV_KEY::KEY_CHANNELDOWN) => {
                event::KeyCode::KC_CHANNELDOWN
            }
            ...
            enums::EventCode::EV_KEY(enums::EV_KEY::KEY_VIDEOPHONE) => {
                event::KeyCode::KC_VIDEOPHONE
            }
            ...
            enums::EventCode::EV_KEY(enums::EV_KEY::KEY_SPREADSHEET) => {
                event::KeyCode::KC_SPREADSHEET
            }
            ...
            enums::EventCode::EV_KEY(enums::EV_KEY::KEY_ADDRESSBOOK) => {
                event::KeyCode::KC_ADDRESSBOOK
            }
            ...
            enums::EventCode::EV_KEY(enums::EV_KEY::KEY_SPELLCHECK) => {
                event::KeyCode::KC_SPELLCHECK
            }
            ...
            enums::EventCode::EV_KEY(enums::EV_KEY::KEY_WPS_BUTTON) => {
                event::KeyCode::KC_WPS_BUTTON
            }
            enums::EventCode::EV_KEY(enums::EV_KEY::KEY_TOUCHPAD_TOGGLE) => {
                event::KeyCode::KC_TOUCHPAD_TOGGLE
            }
            enums::EventCode::EV_KEY(enums::EV_KEY::KEY_TOUCHPAD_ON) => {
                event::KeyCode::KC_TOUCHPAD_ON
            }
            ...
            enums::EventCode::EV_KEY(enums::EV_KEY::KEY_CAMERA_DOWN) => {
                event::KeyCode::KC_CAMERA_DOWN
            }
            enums::EventCode::EV_KEY(enums::EV_KEY::KEY_CAMERA_LEFT) => {
                event::KeyCode::KC_CAMERA_LEFT
            }
            ...
            enums::EventCode::EV_KEY(enums::EV_KEY::KEY_ALS_TOGGLE) => {
                event::KeyCode::KC_ALS_TOGGLE
            }
            ...
            enums::EventCode::EV_KEY(enums::EV_KEY::KEY_TASKMANAGER) => {
                event::KeyCode::KC_TASKMANAGER
            }
            ...
            enums::EventCode::EV_KEY(enums::EV_KEY::KEY_SCREENSAVER) => {
                event::KeyCode::KC_SCREENSAVER
            }
            ...
            enums::EventCode::EV_KEY(enums::EV_KEY::KEY_RIGHT_DOWN) => {
                event::KeyCode::KC_RIGHT_DOWN
            }
            ...
            enums::EventCode::EV_KEY(enums::EV_KEY::KEY_NUMERIC_11) => {
                event::KeyCode::KC_NUMERIC_11
            }
            enums::EventCode::EV_KEY(enums::EV_KEY::KEY_NUMERIC_12) => {
                event::KeyCode::KC_NUMERIC_12
            }
            enums::EventCode::EV_KEY(enums::EV_KEY::KEY_AUDIO_DESC) => {
                event::KeyCode::KC_AUDIO_DESC
            }
            ...
            enums::EventCode::EV_KEY(enums::EV_KEY::KEY_STOP_RECORD) => {
                event::KeyCode::KC_STOP_RECORD
            }
            ...
            enums::EventCode::EV_KEY(enums::EV_KEY::KEY_FASTREVERSE) => {
                event::KeyCode::KC_FASTREVERSE
            }
            enums::EventCode::EV_KEY(enums::EV_KEY::KEY_SLOWREVERSE) => {
                event::KeyCode::KC_SLOWREVERSE
            }
...
impl Into<event::KeyState> for i32 {
    fn into(self) -> event::KeyState {
        match self {
            0 => event::KeyState::Up,
